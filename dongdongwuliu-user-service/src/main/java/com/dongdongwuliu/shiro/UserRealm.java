...
//执行认证逻辑
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        //获取数据库的用户名和密码
        TbUserDTO user = userService.getInfoByName(token.getUsername());
        ...
        return user ==  null ? null : new SimpleAuthenticationInfo(user,user.getPassword(), ByteSource.Util.bytes(user.getSalt()),user.getUsername());
    }
